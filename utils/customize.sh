...
case $# in
  2)
    ...
    filelist_1="python/src/${module_newname}_module.i CMakeLists.txt python/src/MyClass.i python/src/MyClass_doc.i python/src/CMakeLists.txt lib/src/${module_newname}/MyClass.hxx lib/src/MyClass.cxx lib/include/${module_newname}/${module_Newname}.hxx lib/src/CMakeLists.txt lib/test/CMakeLists.txt lib/test/t_MyClass_std.cxx python/test/CMakeLists.txt python/test/t_MyClass_std.py python/doc/user_manual/user_manual.rst python/doc/examples/plot_example1.py"
    ...
    filelist_2="python/src/MyClass.i python/src/MyClass_doc.i lib/src/MyClass.cxx lib/src/${module_newname}/MyClass.hxx lib/test/t_MyClass_std.cxx python/test/t_MyClass_std.py"
